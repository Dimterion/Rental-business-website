export default [
  {
    ...
    description:
      "Your home away from home. Whether you're coming from the other side of the world or just a few metro stations away, you'll feel at home in your new appartment.",
    host: {
      name: "Nathalie Jean",
      picture:
  ...
  },
  {
    ...
    description:
      "Immerse yourself in the charm of the Parisian lifestyle in this beautiful apartment. Only 3 minutes from Saint Martin's Canal and close to public transportation and shops. Fully equiped, the apartment also has a parking space.",
    host: {
      name: "Della Case",
      picture:
  ...
  },
  {
    ...
    description:
      "Only a short walk away from the Buttes Chaumont park, this is the perfect spot for visiting Paris.  Fully equiped for your confort (and decorated), you'll live like a Parisian while you're here.",
    host: {
      name: "Franck Maher",
      picture:
    ...
    Amenities: ["Wifi", "Equiped Kitchen", "TV", "Hair Dryer"],
    tags: ["Buttes Chaumont", "Laumiere", "Studio"],
  },
  {
    id: "7af00cd6",
    ...
    description:
      "Come and discover Paris by staying in this cosy nest in the heart of the 11th district. The view from this residential park will make you feel rested after long days of visiting the French capital. And for the partygoers among you, the rue Jean Pierre Timbaud will allow you to discover the Parisian night-life only 5 minutes away from the apartment.",
    host: {
      name: "Della Case",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-1.jpg",
    ...
    Amenities: ["Microwave", "Wifi", "Private Room", "Air Conditioning", "TV"],
  ...
  },
  {
    ...
    description:
      "This fully renovated loft, equiped with luxury furniture will seduce you. Ideally located in the 10th district, moving around Paris will be child's play.",
    host: {
      name: "Franck Maher",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-2.jpg",
  ...
  },
  {
    ...
    description:
      "Come and immerse yourself in Parisian culture in this tastefully decorated former artist's studio in the heart of Montmartre.",
    host: {
      name: "Line Rolland",
      picture:
    ...
    Amenities: ["Private Room", "Parking space"],
    tags: ["Montmartre", "Culture", "Charm"],
  },
  {
    id: "b4c67936",
    ...
    description:
      "This fully functional Studio will be your perfect pied-à-terre for all your Parisian excursions. Ideally located near lines 2 and 4, you will quickly reach all the tourist points of Paris.",
    host: {
      name: "Hugo Perrier",
      picture:
    ...
    tags: ["Transportation", "Cheap", "18th Arrondissement"],
  },
  {
    id: "bc6f7112",
    ...
    tags: ["Luxery", "Eiffel Tower", "3 bedroom", "6th Arrondissement"],
  },
  {
    id: "cb2f9222",
    ...
    tags: ["Montparnasse", "Shops", "Family"],
  },
  {
    id: "d60ca600",
    ...
    description:
      "Relaxation in the heart of Paris? It's possible! Overlooking a residential park, you will be able to open the windows without having to suffer from the noise of cars and pollution. On the contrary, you will be able to listen to the birds. Our apartment is also ideally located in the heart of the 11th district. Close to lines 3 and 2, you will be able to discover Paris without effort!",
    host: {
      name: "Adrien Chiran",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-6.jpg",
    ...
    tags: ["Père Lachaise", "11th Arrondissement", "Metro 3", "Metro 2"],
  },
  {
    id: "2cf259e1",
    ...
    description:
      "Located in the heart of the Marais, our studio is ideal for tourists looking for discovery. Its fully equipped kitchen is particularly practical.",
    host: {
      name: "Victor Moran",
      picture:
    ...
    equipments: ["Fold-out Couch", "Oven", "Hair Dryer", "Wifi"],
  ...
  },
  {
    ...
    description:
      "Ideally located 2 steps from the Place de la République, this particularly functional studio is perfect for discovering Paris. Close to all points of interest thanks to the 5 metro lines which are 5 minutes away, you will be able to make the most of your time in the capital.",
    host: {
      name: "Sarah Devit",
      picture:
    ...
    equipments: ["Storage", "Bed", "Hair Dryer", "Wifi", "TV", "Kettle"],
    tags: ["Marais", "Republique", "Studio", "Close to Metros", "Shops"],
  },
  {
    id: "af6d2d48",
    ...
    description:
      "Leave Paris and go green. Only 30 minutes from the Gare du Nord train station, come and discover the Ecouen forest directly from the window of your bungalow. Fully equipped, this accommodation will welcome you in comfort, while allowing you to concentrate on the essentials. In the morning, open the windows and enjoy the birds singing.",
    host: {
      name: "Sarah Devit",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-8.jpg",
    ...
    tags: ["Forest", "Nature", "Ecouen Museum"],
  },
  {
    id: "7cbb378e",
    ...
    description:
      "Looking for a place to celebrate a birthday with friends while staying close to Paris? Look no further! Fully equipped, this house is the perfect place to get together.",
    host: {
      name: "Karen Guillet",
      picture:
  ...
  },
  {
    ...
    description:
      "4 bedroom house. Ideal for large groups. 45 minutes from Paris Saint-Lazare.",
    host: {
      name: "Karen Guillet",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-9.jpg",
  ...
  },
  {
    ...
    description:
      "If you're looking for the perfect place to put your suitcases between business meetings, look no further. Our loft is the perfect place. Right in the heart of La Défense, it also has all the amenities to make you feel at home.",
    host: {
  ...
  },
  {
    ...
    description:
      "This charming apartment offers luxury amenities at the gates of Paris. A stone's throw from line 3, you will be able to access all the tourist attractions you have always dreamed of.",
    host: {
      name: "Julie Donatella",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-10.jpg",
    ...
    rating: "4",
    location: "Levallois",
    Amenities: ["TV", "Oven", "Fridge", "Hair Dryer", "Wifi", "Microwave"],
    tags: ["Park View", "Charming"],
  },
  {
    id: "2139a317",
    ...
    rating: "2",
    location: "Paris - 20th Arrondissement",
    Amenities: ["Kettle", "Wifi", "Microwave"],
    tags: ["Parc View", "Metros"],
  },
  {
    id: "6ff132c6",
    ...
    description:
      "This tastefully decorated studio will be your cozy nest after a long day spent discovering Paris.",
    host: {
      name: "Michel Romy",
      picture:
    ...
    Amenities: ["Basic Appliances", "Oven", "Fridge", "Wifi", "Microwave"],
    tags: ["Studio", "Charming", "13th Arrondissement"],
  },
  {
    id: "cb02d69b",
    ...
    description:
      "In the heart of the historic Marais district, this apartment is ideal for a couple discovering Paris. Located on the rue de Rivoli, it is 5 minutes from the Louvre.",
    host: {
      name: "Nathalie Jean",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg",
    ...
    rating: "4",
    location: "Paris - 13th Arrondissement",
    Amenities: ["Wifi", "Basic Appliances", "Microwave", "Fridge", "Bathtub"],
